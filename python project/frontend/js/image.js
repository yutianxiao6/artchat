(function () {
  ...
  function injectCanvasStyles() {
    ...
    style.textContent = `
      ...
      .asset-library-modal.hidden{display:none}.asset-library-modal{position:fixed;inset:0;z-index:1600}.asset-library-backdrop{position:absolute;inset:0;background:rgba(2,6,23,.7);backdrop-filter:blur(4px)}.asset-library-panel{position:relative;width:min(1100px,calc(100vw - 48px));height:min(760px,calc(100vh - 48px));margin:24px auto;background:#0f172a;border:1px solid rgba(148,163,184,.18);border-radius:20px;box-shadow:0 30px 80px rgba(0,0,0,.45);display:grid;grid-template-columns:280px 1fr;overflow:hidden}.asset-library-sidebar{padding:18px;border-right:1px solid rgba(148,163,184,.14);display:flex;flex-direction:column;gap:12px;background:#111827}.asset-library-content{padding:18px;display:flex;flex-direction:column;gap:14px;min-width:0}.asset-folder-list,.asset-grid{display:grid;gap:10px;overflow:auto}.asset-folder-item{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:12px 14px;border-radius:14px;border:1px solid rgba(148,163,184,.12);background:#0f172a;cursor:pointer}.asset-folder-item.active{border-color:#60a5fa;background:rgba(37,99,235,.14)}.asset-grid{grid-template-columns:repeat(auto-fill,minmax(200px,1fr))}.asset-card{border:1px solid rgba(148,163,184,.12);border-radius:16px;overflow:hidden;background:#111827}.asset-card img{width:100%;aspect-ratio:1.2/1;object-fit:cover;background:#0b1220}.asset-card-body{padding:12px;display:grid;gap:8px}.asset-modal-header{display:flex;align-items:center;justify-content:space-between;gap:12px}.asset-modal-actions{display:flex;gap:8px;flex-wrap:wrap}
