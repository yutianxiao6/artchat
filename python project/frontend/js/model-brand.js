(function () {
  const BRAND_MAP = [
    { key: "gpt", label: "GPT", aliases: ["gpt", "o1", "o3", "o4", "dall", "gpt-image", "openai", "chatgpt"], logo: "/static/assets/model-icons/runtime/gpt.png", shortLabel: "GPT", colors: ["#10b981", "#065f46"] },
    { key: "gemini", label: "Gemini", aliases: ["gemini", "google", "imagen"], logo: "/static/assets/model-icons/runtime/gemini.png", shortLabel: "Gemini", colors: ["#60a5fa", "#4f46e5"] },
    { key: "deepseek", label: "DeepSeek", aliases: ["deepseek"], logo: "/static/assets/model-icons/runtime/deepseek.png", shortLabel: "DeepSeek", colors: ["#38bdf8", "#0f766e"] },
    { key: "grok", label: "Grok", aliases: ["grok", "xai"], logo: "/static/assets/model-icons/runtime/grok.png", shortLabel: "Grok", colors: ["#111827", "#334155"] },
    { key: "llama", label: "Llama", aliases: ["llama"], logo: "/static/assets/model-icons/runtime/Llama.png", shortLabel: "Llama", colors: ["#14b8a6", "#0f766e"] }
  ];
